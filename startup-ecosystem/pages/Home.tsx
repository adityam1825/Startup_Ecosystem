        ...
        <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="text-left">
            ...
            <p className="text-slate-400 text-lg md:text-xl max-w-lg mb-8 leading-relaxed">
              Startup Ecosystem builds the digital foundation for tomorrow's unicorns. From high-scale web platforms to brand identity and funding strategy.
            </p>
      ...
      <section className="py-20 border-y border-white/5 bg-[#050b1d]">
        <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
           {[
             ...
             { label: "Client Valuation", value: "$2M+" },
